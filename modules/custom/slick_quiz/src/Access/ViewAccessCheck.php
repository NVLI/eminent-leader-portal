...
/**
 * @file
 * Contains \Drupal\slick_quiz\Access\ViewAccessCheck.
 */
...
class ViewAccessCheck implements AccessInterface {
  ...
  public function access($slick_quiz, AccountInterface $account) {
    return AccessResult::allowedIf($account->hasPermission('view own slick_quiz entity') && $this->isOwnEntity($slick_quiz));
  }
