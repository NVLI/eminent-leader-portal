...
/**
 * @file
 * Contains \Drupal\slick_quiz\Access\EditAccessCheck.
 */
...
class EditAccessCheck implements AccessInterface {
  ...
  public function access($slick_quiz, AccountInterface $account) {
    return AccessResult::allowedIf($account->hasPermission('edit own slick_quiz entity') && $this->isOwnEntity($slick_quiz));
  }
